...
DOCKER_MAC_APP_DIR_SIZE_M=1145 # to update run 'du -sm /Applications/Docker.app'
...
CLIENT_DMG_DL_URL="https://github.com/GenesisKernel/genesis-front/releases/download/v0.5.0/Genesis-0.5.0.dmg"
...
CLIENT_APPIMAGE_DL_URL="https://github.com/GenesisKernel/genesis-front/releases/download/v0.5.0/genesis-front-0.5.0-x86_64.AppImage"
